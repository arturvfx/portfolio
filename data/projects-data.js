 ...
 * - desktopFocusX: number (optional desktop cover focal point, 0–100; defaults to 50)
 * - desktopFocusY: number (optional desktop cover focal point, 0–100; defaults to 50)
 * - desktopCoverScale: number (optional desktop cover zoom, 100–200; defaults to 100)
 * - heroFocusX: number (optional desktop Featured Hero focal point, 0–100; defaults to 50)
 * - heroFocusY: number (optional desktop Featured Hero focal point, 0–100; defaults to 50)
 * - heroCoverScale: number (optional desktop Featured Hero zoom, 100–200; defaults to 100)
 ...
 * - translations: { en: { title, browserTitle, category, services, projectSummary, contribution } }
 * - published: boolean
 * - order: number
 */
